...
## [1.7.0](https://github.com/rezozero/tree-walker/compare/1.6.0...1.7.0) - 2026-02-03

### ⚠ Breaking changes

- Requires PHP 8.2 minimum
- Requires Symfony 6.4 minimum

### Bug Fixes

- **(serializer)** Migrate serializer annotations namespace to attribute and improve phpdoc annotations - ([14431b5](https://github.com/rezozero/tree-walker/commit/14431b5488cd538218272ba4d87cdbf0e8886992))
